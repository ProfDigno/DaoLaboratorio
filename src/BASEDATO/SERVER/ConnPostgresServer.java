 ...
 * @author Pc
 */
public class ConnPostgresServer {
...
//    ConnSQLITEdato csd = new ConnSQLITEdato();
    ...
    private void cargar_jsom_conexion() {
        JSONParser parser = new JSONParser();
        try {
            Object obj = parser.parse(new FileReader("src\\json_conexion_server.json"));
    ...
    public void ConnectDBpostgresServer( boolean msj) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Ocurrio un error en la conexion con base de datos"
                    ...
                    + "\nPuerto: " + PsPort
                    + "\nUsuario: " + PsUsuario
                    + "\nError: " + e.getMessage(), "ERROR CONEXION SERVER", JOptionPane.ERROR_MESSAGE);
            JOptionPane.showMessageDialog(null, "EL SISTEMA SE VA CERRAR POR FALLA EN LA CONEXION", "ERROR CONEXION SERVER", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }
    }
     ...
     */
    public static Connection getConnPosgresServer() {
