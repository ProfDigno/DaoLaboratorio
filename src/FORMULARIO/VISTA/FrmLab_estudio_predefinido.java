 ...
 * @author Digno
 */
public class FrmLab_estudio_predefinido extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private lab_estudio_predefinido lep = new lab_estudio_predefinido();
    private BO_lab_estudio_predefinido lepBO = new BO_lab_estudio_predefinido();
    private DAO_lab_estudio_predefinido lepDAO = new DAO_lab_estudio_predefinido();
    EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_pelete clacolor= new cla_color_pelete();
    private void abrir_formulario() {
        this.setTitle("ESTUDIO PREDEFINIDO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        lepDAO.actualizar_tabla_lab_estudio_predefinido(conn, tbllab);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            lep.setC2nombre(txtnombre.getText());
            lep.setC3es_anormal(jCes_normal.isSelected());
            lepBO.insertar_lab_estudio_predefinido(lep, tbllab);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            lep.setC1idlab_estudio_predefinido(Integer.parseInt(txtid.getText()));
            lep.setC2nombre(txtnombre.getText());
            lep.setC3es_anormal(jCes_normal.isSelected());
            lepBO.update_lab_estudio_predefinido(lep, tbllab);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbllab);
        lepDAO.cargar_lab_estudio_predefinido(conn,lep, idproducto);
        txtid.setText(String.valueOf(lep.getC1idlab_estudio_predefinido()));
        jCes_normal.setSelected(lep.getC3es_anormal());
        txtnombre.setText(lep.getC2nombre());
    ...
    public FrmLab_estudio_predefinido() {
        initComponents();
        abrir_formulario();
    }
    ...
    private void initComponents() {
        ...
        jCes_normal = new javax.swing.JCheckBox();
        ...
        jCes_normal.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jCes_normal.setText("ES NORMAL");
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        lepDAO.ancho_tabla_lab_estudio_predefinido(tbllab);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private javax.swing.JCheckBox jCes_normal;
