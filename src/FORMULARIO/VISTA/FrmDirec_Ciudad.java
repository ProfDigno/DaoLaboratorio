 ...
 * @author Digno
 */
public class FrmDirec_Ciudad extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private direc_ciudad dciu = new direc_ciudad();
    private BO_direc_ciudad dciuBO = new BO_direc_ciudad();
    private DAO_direc_ciudad dciudao = new DAO_direc_ciudad();
    EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_pelete clacolor= new cla_color_pelete();
    private void abrir_formulario() {
        this.setTitle("DIREC CIUDAD");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        dciudao.actualizar_tabla_direc_ciudad(conn, tbllab);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            dciu.setC2nombre(txtnombre.getText());
            dciuBO.insertar_direc_ciudad(dciu, tbllab);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            dciu.setC1iddirec_ciudad(Integer.parseInt(txtid.getText()));
            dciu.setC2nombre(txtnombre.getText());
            dciuBO.update_direc_ciudad(dciu, tbllab);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbllab);
        dciudao.cargar_direc_ciudad(conn,dciu, idproducto);
        txtid.setText(String.valueOf(dciu.getC1iddirec_ciudad()));
        txtnombre.setText(dciu.getC2nombre());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        dciudao.ancho_tabla_direc_ciudad(tbllab);
