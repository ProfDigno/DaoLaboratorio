 ...
 * @author Digno
 */
public class FrmLab_grupo extends javax.swing.JInternalFrame {
    ...
    private void abrir_formulario() {
        this.setTitle("LAB GRUPO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        lgrudao.actualizar_tabla_lab_grupo(conn, tbllab);
        color_formulario();
    }
    ...
    private boolean validar_guardar() {
        ...
        if (evejtf.getBoo_JTextarea_vacio(txtaDescripcion, "DEBE CARGAR UN NOMBRE")) {
            return false;
        }
        return true;
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            lgru.setC2nombre(txtnombre.getText());
            lgru.setC3descripcion(txtaDescripcion.getText());
            lgruBO.insertar_lab_grupo(lgru, tbllab);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            lgru.setC1idlab_grupo(Integer.parseInt(txtid.getText()));
            lgru.setC2nombre(txtnombre.getText());
            lgru.setC3descripcion(txtaDescripcion.getText());
            lgruBO.update_lab_grupo(lgru, tbllab);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbllab);
        lgrudao.cargar_lab_grupo(conn,lgru, idproducto);
        txtid.setText(String.valueOf(lgru.getC1idlab_grupo()));
        txtnombre.setText(lgru.getC2nombre());
        txtaDescripcion.setText(lgru.getC3descripcion());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        lgrudao.ancho_tabla_lab_grupo(tbllab);
