 ...
 * @author Digno
 */
public class FrmOrden_lugar extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    orden_lugar unid = new orden_lugar();
    BO_orden_lugar uBO = new BO_orden_lugar();
    DAO_orden_lugar udao = new DAO_orden_lugar();
    EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_pelete clacolor= new cla_color_pelete();
    private void abrir_formulario() {
        this.setTitle("ORDEN LUGAR");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        udao.actualizar_tabla_orden_lugar(conn, tbllab);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            uBO.insertar_orden_lugar(unid, tbllab);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            unid.setC1idorden_lugar(Integer.parseInt(txtid.getText()));
            unid.setC2nombre(txtnombre.getText());
            uBO.update_orden_lugar(unid, tbllab);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbllab);
        udao.cargar_orden_lugar(conn,unid, idproducto);
        txtid.setText(String.valueOf(unid.getC1idorden_lugar()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        udao.ancho_tabla_orden_lugar(tbllab);
