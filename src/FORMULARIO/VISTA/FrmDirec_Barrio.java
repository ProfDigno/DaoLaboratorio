 ...
 * @author Digno
 */
public class FrmDirec_Barrio extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private direc_barrio dbar = new direc_barrio();
    private BO_direc_barrio dbarBO = new BO_direc_barrio();
    private DAO_direc_barrio dbardao = new DAO_direc_barrio();
    EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_pelete clacolor= new cla_color_pelete();
    private void abrir_formulario() {
        this.setTitle("DIREC BARRIO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        dbardao.actualizar_tabla_direc_barrio(conn, tbllab);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            dbar.setC2nombre(txtnombre.getText());
            dbarBO.insertar_direc_barrio(dbar, tbllab);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            dbar.setC1iddirec_barrio(Integer.parseInt(txtid.getText()));
            dbar.setC2nombre(txtnombre.getText());
            dbarBO.update_direc_barrio(dbar, tbllab);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbllab);
        dbardao.cargar_direc_barrio(conn,dbar, idproducto);
        txtid.setText(String.valueOf(dbar.getC1iddirec_barrio()));
        txtnombre.setText(dbar.getC2nombre());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        dbardao.ancho_tabla_direc_barrio(tbllab);
