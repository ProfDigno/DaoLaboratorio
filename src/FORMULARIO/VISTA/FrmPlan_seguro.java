 ...
 * @author Digno
 */
public class FrmPlan_seguro extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private plan_seguro pseg = new plan_seguro();
    private BO_plan_seguro psegBO = new BO_plan_seguro();
    private DAO_plan_seguro psegdao = new DAO_plan_seguro();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_pelete clacolor= new cla_color_pelete();
    private void abrir_formulario() {
        this.setTitle("PLAN SEGURO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        psegdao.actualizar_tabla_plan_seguro(conn, tbllab);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            pseg.setC2nombre(txtnombre.getText());
            psegBO.insertar_plan_seguro(pseg, tbllab);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            pseg.setC1idplan_seguro(Integer.parseInt(txtid.getText()));
            pseg.setC2nombre(txtnombre.getText());
            psegBO.update_plan_seguro(pseg, tbllab);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbllab);
        psegdao.cargar_plan_seguro(conn,pseg, idproducto);
        txtid.setText(String.valueOf(pseg.getC1idplan_seguro()));
        txtnombre.setText(pseg.getC2nombre());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        psegdao.ancho_tabla_plan_seguro(tbllab);
