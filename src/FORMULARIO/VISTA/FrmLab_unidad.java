 ...
 * @author Digno
 */
public class FrmLab_unidad extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    lab_unidad unid = new lab_unidad();
    BO_lab_unidad uBO = new BO_lab_unidad();
    DAO_lab_unidad udao = new DAO_lab_unidad();
    EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_pelete clacolor= new cla_color_pelete();
    private void abrir_formulario() {
        this.setTitle("LAB UNIDAD");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        udao.actualizar_tabla_lab_unidad(conn, tblpro_unidad);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            uBO.insertar_lab_unidad(unid, tblpro_unidad);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            unid.setC1idlab_unidad(Integer.parseInt(txtid.getText()));
            unid.setC2nombre(txtnombre.getText());
            uBO.update_lab_unidad(unid, tblpro_unidad);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tblpro_unidad);
        udao.cargar_lab_unidad(conn,unid, idproducto);
        txtid.setText(String.valueOf(unid.getC1idlab_unidad()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        udao.ancho_tabla_lab_unidad(tblpro_unidad);
