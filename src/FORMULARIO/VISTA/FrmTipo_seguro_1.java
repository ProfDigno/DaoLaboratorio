 ...
 * @author Digno
 */
public class FrmTipo_seguro_1 extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    EvenJtable eveJtab = new EvenJtable();
    private tipo_seguro tseg = new tipo_seguro();
    private BO_tipo_seguro tsegBO = new BO_tipo_seguro();
    private DAO_tipo_seguro tsegdao = new DAO_tipo_seguro();
    EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_pelete clacolor= new cla_color_pelete();
    private void abrir_formulario() {
        this.setTitle("TIPO SEGURO");
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        tsegdao.actualizar_tabla_tipo_seguro(conn, tbllab);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            tseg.setC2nombre(txtnombre.getText());
            tsegBO.insertar_tipo_seguro(tseg, tbllab);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            tseg.setC1idtipo_seguro(Integer.parseInt(txtid.getText()));
            tseg.setC2nombre(txtnombre.getText());
            tsegBO.update_tipo_seguro(tseg, tbllab);
        }
    }

    private void seleccionar_tabla() {
        int idproducto = eveJtab.getInt_select_id(tbllab);
        tsegdao.cargar_tipo_seguro(conn,tseg, idproducto);
        txtid.setText(String.valueOf(tseg.getC1idtipo_seguro()));
        txtnombre.setText(tseg.getC2nombre());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        tsegdao.ancho_tabla_tipo_seguro(tbllab);
